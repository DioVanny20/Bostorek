		...
		<div class="card">
			...
			<div class="card-body">
				...
				if (isset($_POST['submit'])) {
					...
					$datas = mysqli_query($koneksi, "insert into komentar (nama,email,isi_komentar)values('$nama', '$email', '$isi_komentar')") or die(mysqli_error($koneksi));
					//id barang tidak dimasukkan, karena sudah menggunakan AUTO_INCREMENT, id akan otomatis

					//ini untuk menampilkan alert berhasil dan redirect ke halaman index
					echo "<script>alert('TerimaKasih Telah Berkomentar');window.location='komentar.php';</script>";
				}
				?>
			</div>
		</div>
