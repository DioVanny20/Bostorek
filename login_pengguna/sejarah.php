      ...
      <div class="container ">
        ...
        <div class="row">
          <div class="col-sm-6 col-md-4 ">
            <div class="box ">
              <div class="img-box">
                <img src="image/sejarah/1.jpg" alt="">
              </div>
          ...
          <div class="col-sm-6 col-md-4 ">
            <div class="box ">
              <div class="img-box">
                <img src="image/sejarah/2.png" alt="">
              </div>
              <div class="detail-box">
                <h5>
          ...
          <div class="col-sm-6 col-md-4 ">
            <div class="box ">
              <div class="img-box">
                <img src="image/sejarah/3.jpg" alt="">
              </div>
              <div class="detail-box">
                <h5>
          ...
          <div class="col-sm-6 col-md-4 ">
            <div class="box ">
              <div class="img-box">
                <img src="image/sejarah/4.jpg" alt="">
              </div>
              <div class="detail-box">
                <h5>
          ...
          <div class="col-sm-6 col-md-4 ">
            <div class="box ">
              <div class="img-box">
                <img src="image/sejarah/5.jpg" alt="">
              </div>
              <div class="detail-box">
                <h5>
          ...
          <div class="col-sm-6 col-md-4 ">
            <div class="box ">
              <div class="img-box">
                <img src="image/sejarah/6.png" alt="">
              </div>
              <div class="detail-box">
                <h5>
