          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav">
              <li class="nav-item active">
                <a class="nav-link pl-lg-0" href="read_penjualan.php">Data Jual <span class="sr-only">(current)</span></a>
              </li>
              <li class="nav-item">
    ...
    <div class="catagory_container">
      <div class="container ">
        <div class="heading_container heading_center">
          ...
          <p>
            Disini kami menyediakan kategori-kategori buku yang sering banyak di beli.
          </p>
        </div>
        <div class="row">
          <div class="col-sm-6 col-md-4 ">
            <div class="box ">
              <div class="img-box">
                <a href="#"><img src="../images/cat1.png" alt=""></a>
              </div>
              <div class="detail-box">
                <h5>
                  Pendidikan
                ...
                <a href="tambahdata.php"><h5>Tambah Buku</h5></a>
              </div>
            </div>
          </div>
          <div class="col-sm-6 col-md-4 ">
            <div class="box ">
              <div class="img-box">
               <a href=""><img src="../images/cat2.png" alt=""></a> 
              </div>
              <div class="detail-box">
                <h5>
                  Teknologi
          ...
          <div class="col-sm-6 col-md-4 ">
            <div class="box ">
              <div class="img-box">
                <a href=""><img src="../images/cat3.png" alt=""></a> 
              </div>
              <div class="detail-box">
                <h5>
                  Sejarah
          ...
          <div class="col-sm-6 col-md-4 ">
            <div class="box ">
              <div class="img-box">
                <a href=""><img src="../images/cat5.png" alt=""></a>
              </div>
              <div class="detail-box">
                <h5>
                  Bahasa Inggris
          ...
          <div class="col-sm-6 col-md-4 ">
            <div class="box ">
              <div class="img-box">
                <a href=""><img src="../images/cat6.png" alt=""></a>
              </div>
              <div class="detail-box">
                <h5>
                  Kimia
