	...
	<div class="container col-md-6 mt-4">
		<div class="card">
			<div class="card-header bg-success text-white ">
				DATA BUKU <a href="tambahdata.php" class="btn btn-sm btn-primary float-right">Tambah</a>
			</div>
			<div class="card-body">
				<table class="table table-bordered">
					...
					<tbody>
						<?php
							...
							$datas = mysqli_query($koneksi, "select * from tb_tambahbuku") or die(mysqli_error($koneksi));
